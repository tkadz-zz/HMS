        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card-box bg-red">
                <div class="inner">
                    <h3> <?php
                        $id = $_SESSION['id'];
                        $query = "SELECT * FROM diagnosis WHERE userID='$id'";
                        $o = new Userview();
                        $o->CountView($query);
                        ?>
                    </h3>
                ...
                <a href="medicalHistory.php?userid=<?php echo $_SESSION['id'] ?>" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
